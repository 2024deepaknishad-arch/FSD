...
export default function Backups() {
  const { backups, loading, working, error, createBackup, restoreBackup } = useBackups();
  ...
  return (
    <Layout title="Backups & Recovery">
      ...
      <div className="bg-surface border border-border rounded-lg overflow-hidden">
        ...
        {error && <div className="px-5 py-3 text-xs text-red border-b border-border">{error}</div>}
